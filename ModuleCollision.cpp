...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_WALL_RIGHT] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_WALL_RIGHT] = false;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_WALL_RIGHT] = false;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_ENEMY_SHOT] = false;

	matrix[COLLIDER_WALL_RIGHT][COLLIDER_WALL] = false;
	...
	matrix[COLLIDER_WALL_RIGHT][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_WALL_RIGHT][COLLIDER_ENEMY_SHOT] = false;
}
...
void ModuleCollision::DebugDraw()
{
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_ENEMY_SHOT: // magenta
			...
			break;
		case COLLIDER_WALL_RIGHT: // Black
